	...
	static public void main(String[] args)
	{
		...
		ubxPort.addDataListener(new SerialPortDataListener() {
			...
			public void serialEvent(com.fazecast.jSerialComm.SerialPortEvent event)
			{
				...
				System.out.println("start LISTENING_EVENT_DATA_AVAILABLE...................");
				byte[] newDataRec = event.getReceivedData();
		        String str = new String(newDataRec).split("\n", 2)[0].replaceAll("\\s+", "");
		        System.out.println("Received data: " + str);
		        System.out.println("end LISTENING_EVENT_DATA_AVAILABLE...................");
			}
		});
